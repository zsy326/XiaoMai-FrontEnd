...
<el-form-item label="其他标签（可多选）" prop="region">
  <el-select
    v-model="value"
    multiple
    filterable
...
<el-row :gutter="20">
  <el-col :span="12">
    ...
    <el-input-number v-model="sessionNum" controls-position="right" @change="handleChange1" :min="1" :max="50"></el-input-number>
  </el-form-item>
   ...
   <el-form-item label="开始时间" required>
    <el-col :span="6">
      <el-form-item prop="date1">
        <el-date-picker type="date" placeholder="日期" v-model="ruleForm.date1" style="width: 100%;"></el-date-picker>
      </el-form-item>
    </el-col>
    <el-col class="line" :span="2">-</el-col>
    <el-col :span="6">
      <el-form-item prop="date2">
        <el-time-picker placeholder="时间" v-model="ruleForm.date2" style="width: 100%;"></el-time-picker>
      </el-form-item>
    </el-col>
  </el-form-item>
  ...
  <el-form-item label="添加分区" prop="areaNum">
    <el-input-number v-model="areaNum" controls-position="right" @change="handleChange2" :min="1" :max="50"></el-input-number>
  </el-form-item>
  <el-form-item label="座位数" prop="seatNum">
    <el-input-number v-model="seatNum" controls-position="right" @change="handleChange3" :min="1"></el-input-number>
  </el-form-item>
  <el-form-item label="票价（RMB）" prop="price">
    <el-input-number v-model="price" controls-position="right" @change="handleChange4" :min="0"></el-input-number>
  </el-form-item>
